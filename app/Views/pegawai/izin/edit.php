<?php
// File: app/Views/pegawai/izin/edit.php
// Halaman edit pengajuan izin untuk pegawai
?>
...
<div class="container-fluid px-4">
    <h1 class="mt-4 mb-2">Edit Pengajuan Izin</h1>
    <ol class="breadcrumb mb-4">
        ...
        <li class="breadcrumb-item active">Edit Pengajuan Izin</li>
    </ol>
    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex align-items-center">
                ...
                <h5 class="mb-0">Form Edit Pengajuan Izin</h5>
            </div>
        </div>
        <div class="card-body">
                ...
                <div class="form-section">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="jenis_izin" name="jenis_izin" required>
                            ...
                            <option value="Sakit" <?= $izin['jenisizin'] == 'Sakit' ? 'selected' : '' ?>>Sakit</option>
                            <option value="Cuti" <?= $izin['jenisizin'] == 'Cuti' ? 'selected' : '' ?>>Cuti</option>
                            <option value="Keperluan Keluarga" <?= $izin['jenisizin'] == 'Keperluan Keluarga' ? 'selected' : '' ?>>Keperluan Keluarga</option>
                            <option value="Lainnya" <?= $izin['jenisizin'] == 'Lainnya' ? 'selected' : '' ?>>Lainnya</option>
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="keterangan" name="keterangan" rows="3" placeholder="Jelaskan alasan izin Anda secara detail" required><?= $izin['alasan'] ?></textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <?php if (!empty($izin['lampiran'])) : ?>
                            <div class="current-file">
                                <i class="fas fa-file-alt current-file-icon"></i>
                                <div class="current-file-info">
                                    <div class="current-file-name">File saat ini</div>
                                    <div class="current-file-hint">Upload file baru untuk mengganti</div>
                                    <a href="<?= base_url('uploads/izin/' . $izin['lampiran']) ?>" target="_blank" class="current-file-link">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        // Prepare selected dates
        const selectedDatesData = <?= json_encode($selectedDates) ?>;
        ...
        const fp = flatpickr("#tanggal_izin", {
            ...
            onChange: function(selectedDates, dateStr, instance) {
                ...
                if (selectedDates.length > 1) {
                    ...
                    console.log(`Validasi berurutan (edit): tanggal pertama=${firstDateClean.toISOString().split('T')[0]}, tanggal terakhir=${lastDateClean.toISOString().split('T')[0]}`);
                    console.log(`Validasi berurutan (edit): seharusnya ${expectedDays} hari, aktual ${actualDays} hari`);
                    
                    // Berikan toleransi kecil untuk floating point
                    areConsecutive = (Math.abs(actualDays - expectedDays) < 0.01);
                    
                    console.log(`Hasil validasi (edit): ${areConsecutive ? 'Berurutan' : 'Tidak berurutan'}`);
        ...
        // Update selected dates display immediately
        updateSelectedDatesDisplay(fp.selectedDates);
        ...
        form.addEventListener('submit', function(e) {
            ...
            // Send AJAX request
            fetch('<?= base_url('pegawai/izin/update/' . $izin['idizin']) ?>', {
                    method: 'POST',
                    body: formData,
                    headers: {
