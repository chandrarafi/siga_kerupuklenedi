    ...
    <div class="col-12">
        <div class="card shadow">
            <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Filter Laporan Data Lembur</h5>
            </div>
            <div class="card-body">
                <form id="form-filter">
                    <div class="row g-3">
        ...
        <div class="card shadow" id="reportCard">
            ...
            <div class="card-body" id="reportContent">
                ...
                <div class="text-center p-5">
                    ...
                    <p class="mt-2">Silakan gunakan filter di atas untuk menampilkan data lembur</p>
                </div>
            </div>
        </div>
    </div>
...
<script>
    $(document).ready(function() {
        ...
        function loadReport() {
            $.ajax({
                url: '<?= site_url('admin/lembur/report') ?>',
                type: 'GET',
                data: {
                    pegawai: $('#pegawai').val(),
        ...
        $('#btn-cetak').click(function() {
            ...
            let url = '<?= site_url('admin/lembur/report') ?>';
            let params = [];
        ...
        <?php if (!empty($filters['pegawai']) || !empty($filters['tanggal_awal']) || !empty($filters['tanggal_akhir'])): ?>
            loadReport();
        <?php endif; ?>
    });
</script>
